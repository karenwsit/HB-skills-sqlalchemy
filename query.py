...
def get_model_info(year):
    ...
    for m in models:
		print "" + m.name , m.brand_name , m.brand.headquarters
...
# The returned value is a Brand object with tne name 'Ford'.
# 2. In your own words, what is an association table, and what *type* of relationship
# does an association table manage?
# An association table cross references other tables and has one to many relationships.
